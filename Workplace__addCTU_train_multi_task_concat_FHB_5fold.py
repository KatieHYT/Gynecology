...
### data preparing
train_d = pd.read_csv('/home/katieyth/gynecology/data/5_fold_0%s_train.csv' %(FLAG.fold))
valid_d = pd.read_csv('/home/katieyth/gynecology/data/5_fold_0%s_test.csv' %(FLAG.fold))
